    ...
    return (
        <header className="header">
            <Link className="logo header__logo" to="/">
                <span className="logo__text-main">DIRTY</span>
            </Link>
            ...
            <div className="header-right header__header-right">
                <div className="header-social">
                    <a className="header-social__link" href="https://www.instagram.com/dirtycollective_" target="_blank" rel="noopener noreferrer">
                    ...
                    <a className="header-social__link" href="https://wa.me/555198952680?text=Ol%C3%A1%2C%20gostaria%20de%20saber%20mais%20sobre%20a%20DIRTY!" target="_blank" rel="noopener noreferrer">
